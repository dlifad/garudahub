            ...
            Card(
              child: Column(
                children: const [
                  ...
                  Divider(height: 1),
                  _FeatureTile('Mini Game Penalti', Icons.sports_soccer),
                  Divider(height: 1),
            ...
            Card(
              child: Column(
                children: const [
                  ...
                  Divider(height: 1),
                  _FeatureTile('Diskusi Pertandingan', Icons.forum_outlined),
                  Divider(height: 1),
                  _FeatureTile('Chant Supporter', Icons.vibration),
                  Divider(height: 1),
                  _FeatureTile('Animasi Chant Interaktif', Icons.graphic_eq),
                ],
              ),
            ),
